...
{
	public static Map<String,Integer> CalculateBrams(List<String> options,List<String> votes)
	{
	...
	public static Map<String,Integer> CalculateBrams(List<String> options,List<String> votes,List<String> ganador)
	{
		Map<String,Integer> resultados=new HashMap<String,Integer>();
