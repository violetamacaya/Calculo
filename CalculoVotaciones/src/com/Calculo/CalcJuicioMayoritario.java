...
public class CalcJuicioMayoritario {
	public static Map<String,Integer> CalculateJuicioMayoritario(List<String> options,List<String> votes)
	{
	...
	public static Map<String,Integer> CalculateJuicioMayoritario(List<String> options,List<String> votes,List<String> ganador)
	{
		Map<String,Integer> resultados=new HashMap<String,Integer>();
